...
public class CropImageView extends ImageView {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        mGuidelinesMode = GUIDELINES_ON; //typedArray.getInteger(R.styleable.CropImageView_guidelines, 1);
        mFixAspectRatio = true; //typedArray.getBoolean(R.styleable.CropImageView_fixAspectRatio, false);
